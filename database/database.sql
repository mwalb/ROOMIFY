...
CREATE TABLE public.furniture (
    ...
    condition_status character varying(255),
    posted_by bigint,
    ...
    status character varying(255) DEFAULT 'AVAILABLE',
...
--
-- Name: furniture_images; Type: TABLE; Schema: public; Owner: -
--
...
ALTER TABLE public.furniture ADD CONSTRAINT fk_furniture_shop FOREIGN KEY (shop_id) REFERENCES shops(id);
